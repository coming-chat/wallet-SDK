...
func (a *Any) GetInt128() *BigInt  { return a.Value.(*BigInt) }
func (a *Any) GetInt256() *BigInt  { return a.Value.(*BigInt) }
...
func (a *Any) GetUint128() *BigInt { return a.Value.(*BigInt) }
func (a *Any) GetUint256() *BigInt { return a.Value.(*BigInt) }

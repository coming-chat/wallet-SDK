...
exports.getStartTickIndex = exports.sqrtPriceX64ToTickIndex = exports.tickIndexToSqrtPriceX64 = exports.MIN_SQRT_PRICE = exports.MAX_SQRT_PRICE = exports.TICK_ARRAY_SIZE = exports.MIN_TICK_INDEX = exports.MAX_TICK_INDEX = void 0;
...
function tickIndexToSqrtPriceX64(tickIndex) {
    if (tickIndex > exports.MAX_TICK_INDEX || tickIndex < exports.MIN_TICK_INDEX) {
...
function sqrtPriceX64ToTickIndex(sqrtPriceX64) {
    if (sqrtPriceX64.gt(new anchor_1.BN(exports.MAX_SQRT_PRICE)) || sqrtPriceX64.lt(new anchor_1.BN(exports.MIN_SQRT_PRICE))) {
...
exports.sqrtPriceX64ToTickIndex = sqrtPriceX64ToTickIndex;
function getStartTickIndex(tickIndex, tickSpacing) {
    const ticksInArray = tickSpacing * exports.TICK_ARRAY_SIZE;
